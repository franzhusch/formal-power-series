...
/-
Checking if ContDiffBump has compact support property.
-/
#check ContDiffBump.hasCompactSupport

/-
Checking if phi is defined.
-/
#check phi

/-
Checking if borelFun is defined.
-/
#check borelFun

/-
Checking if smoothBump_eq_myBump is available.
-/
#check smoothBump_eq_myBump

/-
Checking the definition of ContDiffBump.
-/
#print ContDiffBump
